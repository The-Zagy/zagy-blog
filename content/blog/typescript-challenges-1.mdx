...
Today's challenge is the [Cartesian Product](https://github.com/type-challenges/type-challenges/blob/main/questions/27862-medium-cartesianproduct/README.md) challenge, which can be found here.
...
first look at this `Union` type. You can see that it takes a generic that takes `T`,and does a conditional type check but WTF does that `T extends T` do?
...
The answer lies in the concept of **Distributive Conditional Types** Let's explore this further.

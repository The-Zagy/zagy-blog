...
---
hope it won't trigger auto deployment
One of the things I love most about React compared to other fram eworks that I've
used is how exposed you are to JavaScript when you're using it. There's no
template DSL (JSX comples to sensible JavaScript), the component API has only

...
nagy editing azzzm watching

When you want to disply a list of items to a user, I'm afraid `.join(', ')`
just won't cut it:
...
Ok, so bust out your strin concat skills right? That's what I did... but
